...
struct UserSettingsView: View {
                ...
                ScrollView {
                    VStack(spacing: 0) {
                        ...
                        VStack(spacing: 0) {
                            ...
                            SettingsRow(
                                icon: "lock.fill", title: NSLocalizedString("パスワード変更", comment: "")
                            ) {
                            ...
                            Button(action: {
                                ...
                                HStack {
                                    Image(
                                        systemName: notificationService.isAuthorized
                            ...
                            // 利用規約
                            SettingsRow(
                                icon: "doc.text.fill", title: NSLocalizedString("利用規約", comment: "")
                            ) {
                            ...
                            Button(action: {
                                ...
                                HStack {
                                    Image(systemName: "arrow.right.square.fill")
                                        .foregroundColor(
                                            colorScheme == .dark ? .red.opacity(0.8) : .red
                                        )
                                        .font(.system(size: 20))
                                        .frame(width: 24, height: 24)
    ...
    private func openPasswordChangeURL() {
        let passwordChangeURL = URL(
            string: "https://google.tama.ac.jp/unicornidm/user/tama/password/")!
...
struct DarkModeSettingsView: View {
                        ...
                        appearanceOptionCard(
                            ...
                            action: {
                                withAnimation(.spring(response: 0.3, dampingFraction: 0.7)) {
                                    ...
                                    let systemIsDark =
                                        appearanceManager.getCurrentInterfaceStyle() == .dark
    ...
    private func appearanceOptionCard(
        title: String, icon: String, description: String, isSelected: Bool,
            ...
            HStack(spacing: 16) {
                ...
                ZStack {
                    Circle()
                        .fill(
                            isSelected
                                ? Color.blue.opacity(0.2) : Color(UIColor.secondarySystemBackground)
                        )
